...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if (!glview) {
        ...
        glview = GLViewImpl::createWithRect("Soul_Knight", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height), 0.5);
        //glview = GLViewImpl::createWithFullScreen("Sout_Knight");
#else
